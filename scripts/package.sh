...
cp -r ${TARGET} ${LDK_FILES_DIR}/boing.png ${IPK_EXEC_DIR}
#rm ${TARGET}

cp ${LDK_FILES_DIR}/boing.lnk ${LNK_DESTINATION_DIR}
...
ar r ${BUILD_DIR}/boing.ipk ${IPK_WORKING_DIR}/control.tar.gz ${IPK_WORKING_DIR}/data.tar.gz ${IPK_WORKING_DIR}/debian-binary
